...
const services = [
  { img: 'https://images.unsplash.com/photo-1541888946425-d81bb19480c5?q=80&w=2670&auto=format&fit=crop', title: 'Civil Construction', span: 'col-span-1 md:col-span-2 lg:col-span-2 row-span-2', desc: 'Complete residential civil construction with expert supervision and quality workmanship.' },
