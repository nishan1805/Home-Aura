...
const services = [
  { img: '/images/Construnction.webp', title: 'Civil Construction', span: 'col-span-1 md:col-span-2 lg:col-span-2 row-span-2', desc: 'Complete residential civil construction with expert supervision and quality workmanship.' },
  { img: '/images/Architecture.webp', title: 'Design: Architecture, Structural & Interior', span: 'col-span-1 md:col-span-2 lg:col-span-2', desc: 'Comprehensive architectural, structural and interior design tailored to your vision.' },
  { img: '/images/Turnkey.webp', title: 'Turnkey Construction', span: 'col-span-1 md:col-span-2 lg:col-span-2', desc: 'End-to-end design and construction solutions from planning to final handover.' },
];
